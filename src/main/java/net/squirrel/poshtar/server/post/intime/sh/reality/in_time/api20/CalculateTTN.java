...
import net.squirrel.poshtar.server.post.intime.ua.intime.inr.in_time.integration20.CalculateRequest;
 ...
 *       &lt;sequence>
 *         &lt;element name="CalculateRequest" type="{http://inr.intime.ua/in-time/integration20}CalculateRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CalculateTTN")
public class CalculateTTN {

    @XmlElement(name = "CalculateRequest", required = true)
