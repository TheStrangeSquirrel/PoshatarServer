...
/**
 * <p>Java class for CargoTypesListRespond complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CargoTypesListRespond">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="InterfaceState" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="CargoType" type="{http://www.reality.sh/in-time/integration}CargoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CargoTypesListRespond", propOrder = {
    "interfaceState",
    "cargoType"
})
public class CargoTypesListRespond {

    @XmlElement(name = "InterfaceState", required = true)
    protected String interfaceState;
    @XmlElement(name = "CargoType")
    protected List<CargoType> cargoType;
     ...
     * 
     */
    public List<CargoType> getCargoType() {
        if (cargoType == null) {
            cargoType = new ArrayList<CargoType>();
        }
